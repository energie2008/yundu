  ...
  return (
    <div
      className={`relative flex flex-col rounded-2xl p-7 transition-all duration-300 ${
        isPopular
          ? 'bg-white shadow-xl shadow-purple-500/10 ring-2 ring-[var(--primary)]/30 scale-[1.02]'
          : 'bg-white/60 backdrop-blur-sm border border-[var(--border)] hover:shadow-lg hover:border-[var(--primary)]/20'
      }`}
    >
      {isPopular && (
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {features.map((f, i) => (
              <div
                key={i}
                className="group p-7 rounded-2xl bg-white/50 border border-[var(--border)] backdrop-blur-sm transition-all duration-300 hover:bg-white hover:shadow-lg hover:shadow-purple-500/5 hover:-translate-y-1"
              >
                <div
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {testimonials.map((t, i) => (
              <div
                key={i}
                className="group p-7 rounded-2xl bg-white/50 border border-[var(--border)] backdrop-blur-sm transition-all duration-300 hover:bg-white hover:shadow-lg hover:-translate-y-1"
              >
                <Quote
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {faqs.map((item, i) => (
              <div
                key={i}
                className="p-6 rounded-2xl bg-white/50 border border-[var(--border)] backdrop-blur-sm transition-all hover:bg-white hover:border-[var(--primary)]/20"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative">
              ...
              <Link
                to="/register"
                className="inline-flex items-center gap-2 px-8 py-4 rounded-xl bg-white font-medium text-sm transition-all hover:shadow-xl hover:-translate-y-0.5"
                style={{ color: 'var(--primary)' }}
              >
                免费注册
                <ArrowRight className="w-4 h-4" />
