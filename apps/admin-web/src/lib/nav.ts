...
export function getTabGroup(pathname: string): TabGroup {
  if (pathname.startsWith('/nodes') || pathname.startsWith('/node-groups') || pathname.startsWith('/machines') || pathname.startsWith('/servers') || pathname.startsWith('/health-dashboard') || pathname.startsWith('/rule-sets') || pathname.startsWith('/route-policies') || pathname.startsWith('/proxy-chains') || pathname.startsWith('/deployments') || pathname.startsWith('/compiler-workbench')) return 'nodes'
