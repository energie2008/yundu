...
export const EP = {
  ...
  // 全局邮件群发（促销/通知）：POST /admin/mail/broadcast
  MAIL_BROADCAST: '/admin/mail/broadcast',
  ...
  SERVER_RESTART_KERNEL: (id: string) => `/admin/servers/${id}/restart-kernel`,
  SERVER_RELOAD_CONFIG: (id: string) => `/admin/servers/${id}/reload-config`,
SERVER_HEALTH_DASHBOARD: '/admin/servers/health-dashboard',
